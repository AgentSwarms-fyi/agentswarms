...
permissive licenses (MIT, Apache-2.0, ISC, BSD-2-Clause, MIT-0).
...
CSS tool reached via Vite and Tailwind's Vite plugin, weak per-file copyleft,
not part of the shipped bundle). Apache-2.0 dependencies require their license and notice files to
...
| [sonner](https://github.com/emilkowalski/sonner), [cmdk](https://github.com/dip/cmdk), [vaul](https://github.com/emilkowalski/vaul), [react-hook-form](https://github.com/react-hook-form/react-hook-form)                                                           | MIT              | Toasts, command menu, drawers, forms                           |
...
| Project                                                                                                                                                                                | License | Used for                                                                                                                                                                                      |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [LangChain.js / LangGraph](https://github.com/langchain-ai/langchainjs)                                                                                                                | MIT     | Export targets: agents and swarms export as LangChain and LangGraph programs, and the packages are declared so that generated code type-checks. The app's own agent loop does not run on them |
| [XYFlow (React Flow)](https://github.com/xyflow/xyflow)                                                                                                                                | MIT     | The visual swarm and ETL canvases                                                                                                                                                             |
| [CodeMirror](https://github.com/codemirror/dev) + [react-codemirror](https://github.com/uiwjs/react-codemirror)                                                                        | MIT     | Python editors: ETL code mode, MCP Builder, notebooks                                                                                                                                         |
...
| [DuckLake](https://github.com/duckdb/ducklake) + the DuckDB [httpfs](https://github.com/duckdb/duckdb-httpfs), [postgres](https://github.com/duckdb/duckdb-postgres) and [azure](https://github.com/duckdb/duckdb-azure) extensions; DuckDB's own parser (`json_serialize_sql`) is what the row-filter and column-mask rewrite works on | MIT          | The lakehouse's transactional catalog, object-storage reads and Azure lakes                                                   |
...
- **[Ergast Motor Racing Data](https://ergast.com/mrd/)**, via its successor
  ...
  standings, the drivers' champions 1950–2025 and the constructors' champions
  1958–2025, behind the "Formula 1 Analytics" sample dashboard.
...
the supply-chain and HR tables come from `scripts/buildBiSamples.ts`, the ETL
samples from their pipeline templates, and the rest were written for this
repository. None contains third-party data.
...
| [node-postgres (pg)](https://github.com/brianc/node-postgres)                                               | MIT              | PostgreSQL-family connections: PostgreSQL, CockroachDB, TimescaleDB, AlloyDB, Greenplum, YugabyteDB |
| [mysql2](https://github.com/sidorares/node-mysql2)                                                          | MIT              | MySQL-family connections: MySQL, MariaDB, SingleStore, StarRocks, Apache Doris, PlanetScale         |
| [tedious](https://github.com/tediousjs/tedious)                                                             | MIT              | Microsoft SQL Server (including Azure SQL) and Azure Synapse connections over TDS                   |
...
| [FastMCP](https://github.com/PrefectHQ/fastmcp) + the [MCP Python SDK](https://github.com/modelcontextprotocol/python-sdk)                                                    | Apache-2.0 / MIT                  | MCP Builder servers                                                                       |
...
| [scikit-learn](https://github.com/scikit-learn/scikit-learn), [LightGBM](https://github.com/lightgbm-org/LightGBM), [statsmodels](https://github.com/statsmodels/statsmodels) | BSD-3-Clause / MIT / BSD-3-Clause | Model candidates, preprocessing, forecasting                                              |
...
| [httpx](https://github.com/encode/httpx) + [pydantic](https://github.com/pydantic/pydantic)                                                                                   | BSD-3-Clause / MIT                | httpx is the sandbox helper's HTTP client; pydantic is a companion available to notebooks |
...
| Project                                                                                                                                                                     | License                  | Used for                                                                                  |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | ----------------------------------------------------------------------------------------- |
| [FastAPI](https://github.com/fastapi/fastapi) + [Uvicorn](https://github.com/Kludex/uvicorn)                                                                                | MIT / BSD-3-Clause       | The service                                                                               |
...
| [pdf2image](https://github.com/Belval/pdf2image) → [poppler](https://poppler.freedesktop.org/)                                                                              | MIT → GPL-2.0-or-later   | PDF to PNG for the visual review loop; poppler's `pdftoppm` runs as a separate executable |
