...
| 🧪 **ML Models**                 | **No-code machine learning on the lakehouse**, under **Data & BI → ML Models**: pick a table and a target, a sandbox tries several algorithms under a budget and keeps the best with metrics, importance and a passport; versions with stages; batch predictions back into the lakehouse; an `ml_predict` agent tool; forecasts and forecast-basis alerts on BI dashboards. Governed like everything else: IAM shares, trigger-audited, decision ids.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
