...
| 🏢 **Data Sources**                  | **38 connectors**: 22 databases and warehouses (PostgreSQL, MySQL, SQL Server, Oracle, Snowflake, Databricks, BigQuery, Redshift, Synapse, Trino, Athena, ClickHouse, CockroachDB, TimescaleDB and more) queried in place, read-only, with encrypted credentials; 16 apps (Google Sheets, Stripe, Shopify, HubSpot, Salesforce, Jira, Zendesk, ServiceNow, Intercom, GitHub, Linear, Asana, Freshdesk, Klaviyo, Notion, Airtable) synced into datasets, following changes rather than re-reading where the API allows; and the built-in lakehouse. [Connectors](./docs/DATA_SOURCES.md)                                                                                                                                                                                                                                                                                                                                                                          |
...
- **Coverage** — 38 connectors ([DATA_SOURCES.md](./docs/DATA_SOURCES.md)),
