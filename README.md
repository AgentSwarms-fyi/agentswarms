...
| 🌊 **Streaming sources**             | Kafka / Redpanda topics, Kinesis streams and Pub/Sub subscriptions as ETL sources, read in micro-batches on the schedule with engine-managed offsets (at-least-once, never lost), secrets by name and the egress allow-list enforced before a run starts. [ETL pipelines](./docs/ETL_PIPELINES.md)                                                                                                                                                                                                                                                                                                                                                             |
