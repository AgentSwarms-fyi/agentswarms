...
export const Route = createFileRoute('/contact')({
  head: () => ({
    meta: [
      ...
      { property: 'og:image', content: 'https://storage.googleapis.com/gpt-engineer-file-uploads/A8j55GgL3fSxUGx8RgucpYdm9B63/social-images/social-1776452942019-Captsvvsvsure.webp' },
      { name: 'twitter:image', content: 'https://storage.googleapis.com/gpt-engineer-file-uploads/A8j55GgL3fSxUGx8RgucpYdm9B63/social-images/social-1776452942019-Captsvvsvsure.webp' },
    ],
      ...
      <main className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Feedback, partnership ideas, bug reports, "how do I do X?" — drop
            us a line. A real person on the AgentSwarms team replies within
            1–2 business days.
          </p>
        ...
        {done ? (
          <div className="mt-12 rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Check your inbox — we sent a quick confirmation. We'll follow up
