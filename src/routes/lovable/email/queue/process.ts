...
// Loosely-typed client alias: the email queue writes to log/state/RPC
// surfaces and we don't want strict generated-Database typing here, since
// we work with raw queue payloads (Record<string, unknown>).
