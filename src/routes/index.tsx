...
const DISCORD_URL = "https://discord.gg/wKrpyBqtJ";
        ...
        <div className="mx-auto grid h-16 max-w-7xl grid-cols-[minmax(0,1fr)_auto] items-center gap-2 px-3 sm:flex sm:justify-between sm:px-6">
          ...
          <div className="flex min-w-0 shrink-0 items-center gap-1.5 sm:gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden items-center gap-1.5 text-sm text-muted-foreground transition-colors hover:text-foreground sm:inline-flex border border-border/60 bg-card/60 px-2.5 py-1.5 rounded-md hover:bg-card"
            >
